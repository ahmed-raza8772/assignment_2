...
public class Adapter_For_Table extends RecyclerView.Adapter<Adapter_For_Table.ViewHolder> {
    ...
    public Adapter_For_Table(List<String[]> dataList, String[] columnNames) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.show_table_item, parent, false);
